...
export default class App {
    ...
    fullCircle(player) {
        ...
        this.winnerArray.indexOf(player) === -1 ? this.winnerArray.push(player) : console.log("This item already exists");
    ...
    uniqueKey() {
        ...
        document.querySelector('.unique-pad .' + randomArray[rand] + '-touch').classList.add('active-touch')
    ...
    incrementProgressBar(player) {
        if (document.querySelector('.' + player + ' .bar-progress').offsetWidth < document.querySelector('.' + player + ' .bar-progress-cont').offsetWidth) {
            document.querySelector('.' + player + ' .bar-progress').style.width = document.querySelector('.' + player + ' .bar-progress').offsetWidth + 20 + 'px';
    ...
    progressKamehameha(player) {
        if (document.querySelector('.' + player + '').classList.contains('winner-1')) {
            document.querySelector('.progress-left').style.width = document.querySelector('.progress-left').offsetWidth + 40 + 'px';
            document.querySelector('.progress-right').style.width = document.querySelector('.progress-right').offsetWidth - 40 + 'px';
        }
    ...
    kamehameha() {
        ...
        for (let i = 0; i < document.querySelectorAll('.player-cont').length; i++) {
            if (this.winner[0] != document.querySelectorAll('.player-cont')[i].className.split(' ')[1] && this.winner[1] != document.querySelectorAll('.player-cont')[i].className.split(' ')[1]) {
        ...
        window.addEventListener('keydown', (e) => {
            if (document.querySelector('.progress-right').offsetWidth < 30 || document.querySelector('.progress-right').offsetWidth > 670) {
                console.log('end')
            }
            let key = e.keyCode || e.which;
            switch (key) {
    ...
    lastStay() {
        ...
        document.querySelector('.last-stay .' + randomArray[rand] + '-touch').classList.add('active-touch')
        ...
        window.addEventListener('keydown', (e) => {
            ...
            if (document.querySelectorAll('.circle').length == document.querySelectorAll('.full-circle').length) {
